  ...
  return (
    ...
    <div className="Navbar">
      ...
      <div className="container-fluid px-5 bg-light" style={{backgroundColor:"#f5f5f0"}} >
        <div className="row nav-list-parent">
          <div className="col-xl-2 col-12 d-flex justify-content-center align-items-center">
            <img src={img} className='logo-nav' alt="" />
          </div>
      ...
      {/* javascript:void(0) */}
        ...
        <Link to ='/'><img src={nav1} className='sidenav-logo' alt=''/> Home</Link>
        <Link to="/modularkitchen"><img src={nav3} className='sidenav-logo' alt='' /> Modular Kitchen</Link>
        <Link to="/wardrobe"><img src={nav4} className='sidenav-logo' alt='' /> Wardrobe</Link>
        <Link to="/bedroom"><img src={nav5} className='sidenav-logo' alt=''/> Bedroom</Link>
        <Link to="/livingroom"><img src={nav6} className='sidenav-logo' alt=''/> Living Room</Link>
        <Link to="/bathroom"><img src={nav7} className='sidenav-logo' alt=''/> Bathroom</Link>
        <Link to ='/contact'><img src={nav8} className='sidenav-logo' alt=''/> Contact Us</Link>
      </div>
